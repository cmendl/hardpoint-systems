//	Encapsulate FFTW plans and data arrays for input and output.
//
...
//_______________________________________________________________________________________________________________________
///
/// \brief FFT plan and data arrays for input and output
///
typedef struct
{
	fftw_complex *fft_inp;		//!< input array
	fftw_complex *fft_out;		//!< output array
