...
typedef enum
{
	COLL_PLAT_IN,		//!< soft collision of approaching particles entering the shoulder plateau
	COLL_PLAT_OUT,		//!< soft collision of separating particles leaving the shoulder plateau
	COLL_PLAT_BOUNCE,	//!< bounce-back collision at shoulder plateau for approaching particles with small kinetic energy
	COLL_CORE,			//!< hard collision at core
}
colltype_t;
